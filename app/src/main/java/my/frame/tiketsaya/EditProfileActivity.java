            ...
            public void onClick(View view) {
                ...
                reference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        dataSnapshot.getRef().child("password").setValue(xusername.getText().toString());
                        dataSnapshot.getRef().child("bio").setValue(xusername.getText().toString());
                        dataSnapshot.getRef().child("email_address").setValue(xusername.getText().toString());
                        dataSnapshot.getRef().child("nama_lengkap").setValue(xusername.getText().toString());
                    }
